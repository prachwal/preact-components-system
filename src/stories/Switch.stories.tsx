  ...
  render: () => {
    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
        ...
        />
        <button onClick={() => setChecked(!checked)}>Toggle Switch</button>
      </div>
    );
  },
};
  ...
  render: () => {
    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', minWidth: '300px' }}>
        ...
        />
        <Switch checked={settings.darkMode} onChange={handleChange('darkMode')} label='Dark Mode' />
        <Switch checked={settings.autoSave} onChange={handleChange('autoSave')} label='Auto Save' />
        <Switch
        ...
        >
          <pre style={{ margin: 0, fontSize: '0.875rem' }}>{JSON.stringify(settings, null, 2)}</pre>
        </div>
      </div>
    );
  },
...
export const FormIntegration: Story = {
  render: () => {
    ...
    return (
      ...
      >
        <div style={{ fontWeight: 'bold', marginBottom: '8px' }}>Sign Up Form</div>
...
export const CustomLabels: Story = {
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
      <Switch defaultChecked onLabel='ON' offLabel='OFF' label='With ON/OFF labels' />
      <Switch onLabel='✓' offLabel='✗' label='With checkmarks' />
      <Switch defaultChecked onLabel='1' offLabel='0' label='With binary labels' />
    </div>
  ),
};
  ...
  render: () => {
    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
        ...
        />
        {isLoading && (
          <div style={{ color: '#666', fontSize: '0.875rem' }}>Processing your request...</div>
        )}
      </div>
    );
  },
  ...
  render: () => {
    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', minWidth: '300px' }}>
        <div style={{ fontWeight: 'bold', marginBottom: '8px' }}>Feature Toggles</div>
