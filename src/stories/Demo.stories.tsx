  ...
  return (
    <ThemeProvider>
      <Container maxWidth="lg" style={{ padding: '40px 20px' }}>
        <Stack spacing={4}>
          {/* Header Section */}
          <Paper elevation={0} style={{ padding: '32px', textAlign: 'center', background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)', color: 'white' }}>
            <Icon name="Star" size="large" color="white" style={{ marginBottom: '16px' }} />
            <Typography variant="h2" component="h1" style={{ marginBottom: '16px', color: 'white' }}>
              Preact Components System
            </Typography>
            <Typography variant="body1" style={{ color: 'rgba(255,255,255,0.9)' }}>
              A comprehensive component library with modern design, full accessibility, and TypeScript support
            </Typography>
          </Paper>
                ...
                <Card elevation={2}>
                  ...
                  <CardContent>
                    <Stack spacing={2}>
                      ...
                      <Alert severity="warning" variant="outlined">Warning message</Alert>
                    </Stack>
                  </CardContent>
                </Card>
              </Grid>
                      ...
                      <div style={{ position: 'relative' }}>
                        ...
                        {dropdownOpen && (
                          <ClickAwayListener onClickAway={() => setDropdownOpen(false)}>
                            <Paper elevation={4} style={{ position: 'absolute', top: '100%', marginTop: '8px', padding: '16px', zIndex: 1000 }}>
                              <Typography variant="body2">
                ...
                >
                  ...
                  <CardContent>
                    <Typography variant="body1">
                      This modal demonstrates Portal (rendering outside DOM hierarchy) and FocusTrap (keeping focus within the modal).
                    </Typography>
