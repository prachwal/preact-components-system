...
describe('Typography', () => {
  ...
  it('applies text alignment', () => {
    const { container } = renderWithTheme(<Typography align='center'>Centered</Typography>);
  ...
  it('applies gutterBottom', () => {
    const { container } = renderWithTheme(<Typography gutterBottom>Text with margin</Typography>);
    const element = container.querySelector('.typography');
  ...
  it('renders all typography variants', () => {
    ...
    variants.forEach((variant) => {
      const { container } = renderWithTheme(<Typography variant={variant}>Text</Typography>);
